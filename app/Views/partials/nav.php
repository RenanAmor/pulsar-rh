 ...
 * dos valores: dashboard, indicators, intelligence, history, reports, administration.
 */
$activeNav = $activeNav ?? '';
?>
<nav>
    ...
    <a href="<?= BASE_URL ?>/intelligence" class="<?= $activeNav === 'intelligence' ? 'active' : '' ?>">Centro de Inteligência</a>
